...
export default function PrivacyPolicy() {
	return (
		<div class="policy-container">
			...
			<p>
				This privacy notice for DIRECTV Latin America LLC ("Company," "we,"
			...
			<p class="list">
				...
				<a href="https://ls-ops-map.web.app">https://ls-ops-map.web.app</a>, or
			...
			<p>
				...
				have any questions or concerns, please contact us at jpaz1@dtvpan.com.
			</p>
			...
			<p>
				...
				contents below to find the section you are looking for. You can also{" "}
				<a href="#table-of-contents">click here</a> to go directly to our table
				of contents.
			</p>
			...
			<p>
				...
				how you interact with DIRECTV Latin America LLC and the Services, the
			...
			<p>
				...
				information from third parties other than the google credentials and
				information stipulated in the Google Consent form (read-only view to
			...
			<p>
				...
				information? We may share user information in specific situations the
				Argentinean law may require and only under court order. This application
				does not handle any personal information nor allows for public access
				user creation, it's intended only for in-house use of Directv Latin
				America LLC employees.
			</p>
			...
			<p>
				...
				is by contacting us at jpaz1@dtvpan.com or by phone at +54 11 6560 1091.
			...
			<p class="list">
				<a href="#table-1">1. WHAT INFORMATION DO WE COLLECT?</a>
			</p>
			<p class="list">
				<a href="#table-2">2. HOW DO WE PROCESS YOUR INFORMATION?</a>
			</p>
			<p class="list">
				<a href="#table-3">
			...
			<p class="list">
				<a href="#table-5">5. HOW LONG DO WE KEEP YOUR INFORMATION?</a>
			</p>
			<p class="list">
				<a href="#table-6">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</a>
			</p>
			<p class="list">
				<a href="#table-7">7. DO WE COLLECT INFORMATION FROM MINORS?</a>
			</p>
			<p class="list">
				<a href="#table-8">8. WHAT ARE YOUR PRIVACY RIGHTS?</a>
			</p>
			<p class="list">
				<a href="#table-9">9. CONTROLS FOR DO-NOT-TRACK FEATURES</a>
			</p>
			<p class="list">
				<a href="#table-10">
			...
			<p class="list">
				<a href="#table-11">11. DO WE MAKE UPDATES TO THIS NOTICE?</a>
			</p>
			<p class="list">
				<a href="#table-12">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>
			</p>
			<p class="list">
				<a href="#table-13">
			...
			<h2 id="table-1">1. WHAT INFORMATION DO WE COLLECT?</h2>
			...
			<p class="list">usernames</p>

			<p class="list">passwords</p>

			<p class="list">mailing addresses</p>
			...
			<h2 id="table-2">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
			...
			<h2 id="list">5. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
			...
			<h2 id="table-6">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
			...
			<h2 id="table-7">7. DO WE COLLECT INFORMATION FROM MINORS?</h2>
			...
			<h2 id="table-8">8. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
			...
			<p>
				...
				email us at joacopaz@gmail.com.
			</p>

			<h2 id="table-9">9. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
			...
			<h2 id="table-11">11. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
			...
			<h2 id="table-12">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>

			<p>
				If you have questions or comments about this notice, you may email us at
				jpaz1@dtvpan.com, joacopaz@gmail.com, phone to +54 11 6560 1091 or by
				post to:
			</p>

			<p>
				DIRECTV Latin America LLC <br />
				Capitán Justo G. Bermúdez 4547 - Complejo Panamerican Bureau Torre I
				Piso 1 <br />
				Buenos Aires
				<br />
				Munro, Partido de Vicente López B1605DII
				<br />
				Argentina
			</p>
			...
			<p>
				...
				your personal information, please contact us at joacopaz@gmail.com,
				jpaz1@dtvpan.com, by phone to +54 11 6560 1091 or by post to the address
				above.
			</p>
		</div>
	);
