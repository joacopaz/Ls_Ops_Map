...
export default function TermsOfUse() {
	return (
		<div className="policy-container">
			...
			<p>We are DIRECTV Latin America LLC ("Company," "we," "us," or "our").</p>

			<p>
				We operate the LS Ops Map app at{" "}
				<a href="https://ls-ops-map.web.app">https://ls-ops-map.web.app</a>, as
			...
			<p>
				If you have any questions or concerns regarding the terms of use of our
				application, please contact us at jpaz1@dtvpan.com, joacopaz@gmail.com
				or phone +54 11 6560 1091.
			</p>

			<p>
				These Legal Terms constitute a legally binding agreement made between
				you, whether personally or on behalf of an entity ("you"), and DIRECTV
				Latin America LLC, concerning your access to and use of the Services.
			...
			<p className="list">
				<a href="#table-1">1. OUR SERVICES</a>
			</p>
			<p className="list">
				<a href="#table-2">2. INTELLECTUAL PROPERTY RIGHTS</a>
			</p>
			<p className="list">
				<a href="#table-3">3. USER REPRESENTATIONS</a>
			</p>
			<p className="list">
				<a href="#table-4">4. PROHIBITED ACTIVITIES</a>
			</p>
			<p className="list">
				<a href="#table-5">5. USER GENERATED CONTRIBUTIONS</a>
			</p>
			<p className="list">
				<a href="#table-6">6. CONTRIBUTION LICENSE</a>
			</p>
			<p className="list">
				<a href="#table-7">7. SERVICES MANAGEMENT</a>
			</p>
			<p className="list">
				<a href="#table-8">8. TERM AND TERMINATION</a>
			</p>
			<p className="list">
				<a href="#table-9">9. MODIFICATIONS AND INTERRUPTIONS</a>
			</p>
			<p className="list">
				<a href="#table-10">10. GOVERNING LAW</a>
			</p>
			<p className="list">
				<a href="#table-11">11. DISPUTE RESOLUTION</a>
			</p>
			<p className="list">
				<a href="#table-12">12. CORRECTIONS</a>
			</p>
			<p className="list">
				<a href="#table-13">13. DISCLAIMER</a>
			</p>
			<p className="list">
				<a href="#table-14">14. LIMITATIONS OF LIABILITY</a>
			</p>
			<p className="list">
				<a href="#table-15">15. INDEMNIFICATION</a>
			</p>
			<p className="list">
				<a href="#table-16">16. USER DATA</a>
			</p>
			<p className="list">
				<a href="#table-17">
			...
			<p className="list">
				<a href="#table-18">18. MISCELLANEOUS</a>
			</p>
			<p className="list">
				<a href="#table-19">19. CONTACT US</a>
			</p>

			<h2 id="table-1">1. OUR SERVICES</h2>
			...
			<h2 id="table-2">2. INTELLECTUAL PROPERTY RIGHTS</h2>
			...
			<p className="list">access the Services; and</p>
			<p className="list">
			...
			<p>
				...
				address your request to: joacopaz@gmail.com or jpaz1@dtvpan.com. If we
			...
			<h2 id="table-3">3. USER REPRESENTATIONS</h2>
			...
			<h2 id="table-4">4. PROHIBITED ACTIVITIES</h2>
			...
			<h2 id="table-5">5. USER GENERATED CONTRIBUTIONS</h2>
			...
			<h2 id="table-6">6. CONTRIBUTION LICENSE</h2>
			...
			<h2 id="table-7">7. SERVICES MANAGEMENT</h2>
			...
			<h2 id="table-8">8. TERM AND TERMINATION</h2>
			...
			<h2 id="table-9">9. MODIFICATIONS AND INTERRUPTIONS</h2>
			...
			<h2 id="table-10">10. GOVERNING LAW</h2>

			<p>
				These Legal Terms shall be governed by and defined following the laws of
				Argentina. Directv Latin America LLC and yourself irrevocably consent
				that the courts of Argentina, Buenos Aires shall have exclusive
				jurisdiction to resolve any dispute which may arise in connection with
				these Legal Terms.
			</p>

			<h2 id="table-11">11. DISPUTE RESOLUTION</h2>
			...
			<p>
				...
				be 2. The seat, or legal place, or arbitration shall be Argentina,
				Buenos Aires. The language of the proceedings shall be Spanish. The
			...
			<h2 id="table-12">12. CORRECTIONS</h2>
			...
			<h2 id="table-13">13. DISCLAIMER</h2>
			...
			<h2 id="table-14">14. LIMITATIONS OF LIABILITY</h2>
			...
			<h2 id="table-15">15. INDEMNIFICATION</h2>
			...
			<h2 id="table-16">16. USER DATA</h2>
			...
			<h2 id="table-18">18. MISCELLANEOUS</h2>
			...
			<h2 id="table-19">19. CONTACT US</h2>
			...
			<p className="list">joacopaz@gmail.com</p>
			<p className="list">jpaz1@dtvpan.com</p>
			<p className="list">+54 11 6560-1091 (phone)</p>
		</div>
	);
}
